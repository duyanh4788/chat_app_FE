    ...
    <div className="main_form">
      <div className="terms_of_service">
        ...
        <p>
          ...
          website and services ("Platform"). By accessing or using the Platform, you agree to be
          bound by these Terms.
        </p>
        <h2>Privacy Policy</h2>
        <p>
          We are committed to protecting your privacy. This privacy policy ("Privacy Policy")
          explains how we collect, use, and disclose your personal information. By using the
        ...
        <p>
          We use your information to provide and improve the Platform, to communicate with you, and
          to personalize your experience. We may also use your information to show you targeted ads
        ...
        <p>
          ...
          changes, we will notify you by email or by posting a notice on the Platform. Your
          continued use of the Platform after any changes indicates your acceptance of the updated
